...
export class News extends Component {
    ...
    async componentDidMount(){
        let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=5cf4e296897c41bf8321150c826abd9f&page=1&pageSize=${this.props.pageSize}`;
    ...
    handleNext = async () => {
        ...
        // else
        // {
        let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=5cf4e296897c41bf8321150c826abd9f&page=${this.state.page+1}&pageSize=${this.props.pageSize}`;
        this.setState({loading: true})
        let data = await fetch(url);
        let parsedData = await data.json();
        this.setState({
